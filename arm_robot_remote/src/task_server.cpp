...
#include <arm_robot_msgs/action/arm_robot_task.hpp>
...
public:
    ...
    : Node("task_server", options)
  {
    ...
    action_server_ = rclcpp_action::create_server<arm_robot_msgs::action::ArmRobotTask>(
...
private:
  rclcpp_action::Server<arm_robot_msgs::action::ArmRobotTask>::SharedPtr action_server_;

  rclcpp_action::GoalResponse goalCallback(
      const rclcpp_action::GoalUUID& uuid,
      std::shared_ptr<const arm_robot_msgs::action::ArmRobotTask::Goal> goal)
  {
  ...
  rclcpp_action::CancelResponse cancelCallback(
      const std::shared_ptr<rclcpp_action::ServerGoalHandle<arm_robot_msgs::action::ArmRobotTask>> goal_handle)
  { 
    (void)goal_handle;
  ...
  void execute(const std::shared_ptr<rclcpp_action::ServerGoalHandle<arm_robot_msgs::action::ArmRobotTask>> goal_handle)
  {
    RCLCPP_INFO(get_logger(), "Executing goal");
    auto result = std::make_shared<arm_robot_msgs::action::ArmRobotTask::Result>();
...
RCLCPP_COMPONENTS_REGISTER_NODE(arm_robot_remote::TaskServer)